...
const Project = () => {
  ...
  return (
    <main className="h-screen w-screen flex">
      ...
      <section className="right flex flex-grow h-screen bg-red-50">
          ...
          <div className="file-tree w-full">
            {Object.keys(fileTree).map((file) => (
              <div
                ...
                key={file}
                className="file cursor-pointer p-2 hover:bg-slate-500"
              >
        ...
        <div className="code-editor flex flex-col flex-grow h-full shrink">
          <div className="top flex flex-row fle-grow cursor-pointer justify-between w-full">
            <div className="files flex">
              {openFiles.map((file) => (
                <button
                  className="file-tab p-3 hover:bg-slate-500 bg-slate-200 flex justify-between"
        ...
        <div className="flex flex-col h-full ">
          <div className="address-bar">
            ...
            className="w-full p-2 px-4 bg-slate-200" value={iframeUrl} />
          </div>
